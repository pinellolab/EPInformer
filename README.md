...
To predict the gene expression level in *K562* and *GM12878* cells from promoter-enhancer links and the asscociated enhancer activities and HiC contacts, please first run:
```
