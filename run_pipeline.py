...
_PATH_KEYS_SAMPLE = {"accessibility_bam", "h3k27ac_bam", "hic_file", "qnorm_ref", "peaks_file"}
...
def run_encoding_stage(
    ...
    enhancer_list = links_outputs.get(
        "enhancer_list",
        str(links_dir / "Neighborhoods" / "EnhancerList.txt"),
    )
